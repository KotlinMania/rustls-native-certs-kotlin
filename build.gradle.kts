...
kotlin {
    ...
    val xcf = XCFramework("RustlsNativeCerts")

    macosArm64 {
        binaries.framework { baseName = "RustlsNativeCerts"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "RustlsNativeCerts"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "RustlsNativeCerts"
        flattenPackage = "io.github.kotlinmania.rustlsnativecerts"
    }

    android {
        namespace = "io.github.kotlinmania.rustlsnativecerts"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "rustls-native-certs-kotlin", version.toString())

    pom {
        name.set("rustls-native-certs-kotlin")
        description.set("Kotlin Multiplatform port of rustls/rustls-native-certs - rustls-native-certs allows rustls to use the platform native certificate store")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/rustls-native-certs-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/rustls-native-certs-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/rustls-native-certs-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/rustls-native-certs-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.rustlsnativecerts.codeql
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleRustlsNativeCertsXCFramework",
    "assembleRustlsNativeCertsDebugXCFramework",
    "assembleRustlsNativeCertsReleaseXCFramework",
    "assembleDebugIosFatFrameworkForRustlsNativeCertsXCFramework",
    "assembleReleaseIosFatFrameworkForRustlsNativeCertsXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForRustlsNativeCertsXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForRustlsNativeCertsXCFramework",
    "assembleDebugMacosFatFrameworkForRustlsNativeCertsXCFramework",
    "assembleReleaseMacosFatFrameworkForRustlsNativeCertsXCFramework",
    "assembleDebugTvosFatFrameworkForRustlsNativeCertsXCFramework",
    "assembleReleaseTvosFatFrameworkForRustlsNativeCertsXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForRustlsNativeCertsXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForRustlsNativeCertsXCFramework",
    "assembleDebugWatchosFatFrameworkForRustlsNativeCertsXCFramework",
    "assembleReleaseWatchosFatFrameworkForRustlsNativeCertsXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForRustlsNativeCertsXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForRustlsNativeCertsXCFramework",
