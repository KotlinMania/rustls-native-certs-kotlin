...
This file is the quick-reference operating contract for rustls-native-certs-kotlin. The longer
...
rustls-native-certs-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`rustls-native-certs`](https://crates.io/crates/rustls-native-certs). Upstream Rust is the behavioral oracle while the
