...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `RustlsNativeCerts.swiftmodule/`
...
//      `import RustlsNativeCerts` above would fail at compile time.
//
//   2. The static archive `libRustlsNativeCerts.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "RustlsNativeCerts" }` and
//      `flattenPackage = "io.github.kotlinmania.rustlsnativecerts"` configuration in
...
//      via the `RustlsNativeCertsLibrary` product.
//
...
final class RustlsNativeCertsExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "RustlsNativeCerts swift module imported cleanly")
    }
}
